    ...
    return (
        <div className="flex flex-col justify-center items-start pb-20">
            <div className='h-screen w-screen flex justify-center items-center'>
                <Fade>
                    <div className={`flex flex-col border-${theme} lg:flex-row`} style={{ width: '45vw', padding: "20px" }}>
            ...
            <div className={`h-96 w-screen second-bg-${theme} flex justify-center items-center`}>
                <Fade direction='up' triggerOnce>
                    <div>
                        <br />
                        <div className={`border-${theme}-tbline flex flex-col 2xl:flex-row`} style={{ width: '45vw', padding: "20px" }}>
                            <br />
                            <br />
