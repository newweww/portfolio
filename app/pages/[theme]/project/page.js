                    ...
                    <div >
                        <div className='flex flex-wrap justify-center'>
                            <Fade delay={200} triggerOnce >
                                <div className={`flex flex-col w-1/2 border-${theme} hover-zoom`} style={{ width: '100%' }} onClick={() => router.push(`/pages/${theme}/projects/nova-bot`)}>
                                    ...
                                    <div className='p-3' style={{ width: '300px' }}>
                                        ...
                                        <div className='flex flex-wrap'>
                                            <span class="inline-block bg-gray-200 text-gray-700 text-xs font-semibold px-2 rounded-full uppercase mr-1 mb-1">NodeJs</span>
                                            <span class="inline-block bg-gray-200 text-gray-700 text-xs font-semibold px-2 rounded-full uppercase mr-1 mb-1">ReactJs</span>
                                            <span class="inline-block bg-gray-200 text-gray-700 text-xs font-semibold px-2 rounded-full uppercase mr-1 mb-1">Bootstrap</span>
                                            <span class="inline-block bg-gray-200 text-gray-700 text-xs font-semibold px-2 rounded-full uppercase mr-1 mb-1">MongoDB</span>
                                        </div>
                            ...
                            <Fade delay={400} triggerOnce>
                                <div className={`flex flex-col w-1/2 border-${theme} hover-zoom`} style={{ width: '100%' }} onClick={() => router.push(`/pages/${theme}/projects/book-store`)}>
                                    ...
                                    <div className='p-3' style={{ width: '300px' }}>
                                        ...
                                        <div className='flex flex-wrap'>
                                            ...
                                            <span class="inline-block bg-gray-200 text-gray-700 text-xs font-semibold px-2 rounded-full uppercase mr-1 mb-1">ReactJs</span>
                                            <span class="inline-block bg-gray-200 text-gray-700 text-xs font-semibold px-2 rounded-full uppercase mr-1 mb-1">Bootstrap</span>
                                            <span class="inline-block bg-gray-200 text-gray-700 text-xs font-semibold px-2 rounded-full uppercase mr-1 mb-1">MySQL</span>
                                        </div>
