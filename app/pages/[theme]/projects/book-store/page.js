            ...
            <div className="flex flex-col m-auto project-content">
                ...
                <div className='flex justify-center'>
                    <Image
                        ...
                        height={100}
                        alt="Project 2"
                        onClick={() => handleImageClick("/img/projects/project2/home.png")}
                ...
                <div className='flex flex-col items-center'>
                    <Image
                        ...
                        height={100}
                        alt="Project 2"
                        onClick={() => handleImageClick("/img/projects/project2/product-cus.png")}
                        style={{ cursor: 'pointer' }}
                    />
                    <br />
                </div>
                ...
                <div className='flex flex-col items-center'>
                    <Image
                        ...
                        height={100}
                        alt="Project 2"
                        onClick={() => handleImageClick("/img/projects/project2/cart.png")}
                        style={{ cursor: 'pointer' }}
                    />
                    <br />
                    <Image
                        ...
                        height={100}
                        alt="Project 2"
                        onClick={() => handleImageClick("/img/projects/project2/order.png")}
                        style={{ cursor: 'pointer' }}
                    />
                </div>
                <br />
                ...
                <div className='flex flex-col items-center'>
                    <Image
                        ...
                        height={100}
                        alt="Project 2"
                        onClick={() => handleImageClick("/img/projects/project2/dashboard.png")}
                        style={{ cursor: 'pointer' }}
                    />
                    <br />
                    <Image
                        ...
                        height={100}
                        alt="Project 2"
                        onClick={() => handleImageClick("/img/projects/project2/orders.png")}
                        style={{ cursor: 'pointer' }}
                    />
                    <br />
                    <Image
                        ...
                        height={100}
                        alt="Project 2"
                        onClick={() => handleImageClick("/img/projects/project2/product.png")}
                        style={{ cursor: 'pointer' }}
                    />
                </div>
                <br />
