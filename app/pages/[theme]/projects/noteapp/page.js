        ...
        <div className="flex justify-center items-center h-screen">
            <div className="flex flex-col m-auto project-content">
                <div className={`flex flex-col justify-around border-${theme}-btline md:flex-col lg:flex-row xl:flex-row 2xl:flex-row`}>
                    <div>
                        <h5 className={`text-${theme}`} style={{ fontSize: '40px' }}>Note App</h5>
                    </div>
                    <div className="flex flex-row">
                        <a className='md:static lg:static xl:static 2xl:absolute max-w-28' href="https://github.com/newweww/Noteapp" target="_blank" rel="noopener noreferrer">
                ...
                <div className='flex justify-center'>
                    <Image
                        ...
                        height={100}
                        alt="Project 2"
                        onClick={() => handleImageClick("/img/projects/project5/noteapp.png")}
                ...
                <div className='flex flex-col items-center'>
                    <Image
                        src="/img/projects/project5/notegif.gif"
                        width={500}
                        height={100}
                        alt="Project 2"
                        onClick={() => handleImageClick("/img/projects/project5/notegif.gif")}
                        style={{ cursor: 'pointer' }}
                    />
                    <br />
                </div>
