            ...
            <div className="flex flex-col m-auto project-content">
                <div className={`flex flex-col justify-around border-${theme}-btline md:flex-col lg:flex-row xl:flex-row 2xl:flex-row`}>
                    ...
                    <div className='flex flex-row'>
                        <a className='md:static lg:static xl:static 2xl:absolute max-w-28' href="https://github.com/newweww/nova-bot" target="_blank" rel="noopener noreferrer" >
                            <div className={`border-${theme} text-${theme}`}>
                                Github
                            </div>
                        </a>
                        <a className='md:static lg:static xl:static 2xl:absolute max-w-28' href="https://masternova.web.app/" target="_blank" rel="noopener noreferrer" >
                            <div className={`border-${theme} text-${theme}`}>
                                Website
                            </div>
                        </a>
